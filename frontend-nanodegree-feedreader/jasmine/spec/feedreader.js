...
$(function () {
    ...
    describe('RSS Feeds', function () {
         ...
         */
        it('allFeeds object has url defined & is not empty', function () {
            const checkUrl = allFeeds.map(key => !key.url ? false : true);
            expect(checkUrl).toMatch([true, true, true, true]);
        });
         ...
         */
        it('allFeeds object has name defined & is not empty', function () {
 ...
 /* TODO: Write a new test suite named "Initial Entries" */
   ...
   it("News feed has at least single entry",()=>{
    $feed = $('.article.entry');
    expect($($feed)).toExist();
   });
